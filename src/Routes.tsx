...
import { fixturesDateRangeAtom, fixturesSelectedMonth } from "./components/fixtures/calendar/fixtures_calendar.atoms";
    ...
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <Layout>
              <ScopeProvider atoms={[fixturesDateRangeAtom, fixturesSelectedMonth]} >
                <FixtureListScreen />
              </ScopeProvider>
            </Layout>
          </ProtectedRoute>
