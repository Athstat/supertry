...
import { getMyTeamStorageKey } from "../../utils/fantasy/myteamUtils";
...
export default function CreateFantasyTeamProvider({ leagueRound, children }: Props) {
    ...
    const storageKey = getMyTeamStorageKey(leagueRound.id, authUser?.kc_id ?? "");
    ...
    const { data: fakeTeam } = useLocalSave(storageKey, getFakeTeam());
