...
export default function GroupedFixturesList({ fixtures, viewMode = "fixtures", hideCompetitionName = false }: Props) {
                ...
                <div className="flex flex-col gap-3">
                    {fixtures.map((fixture, index) => (
                        <FixtureItem
                            ...
                            viewMode={viewMode}
                            className="rounded-[5px] border w-full dark:border-slate-700 flex-1"
                        />
                    ))}
                </div>
            </div>
