    ...
    return (
        <Fragment>
            <BlueGradientCard className="w-full rounded-xl p-5 bg-gradient-to-br flex flex-col gap-4 lg:p-10" >
                {/* <h1 className="text-xl lg:text-3xl font-bold" >Week {currentRound} 🇿🇼 🇿🇦</h1> */}

                <p className="text-md lg:text-lg font-medium text-slate-200" >
                    {fixturesEnded ?
                        `Its a wrap up for SBR week ${currentRound}. Review your game predictions to see what you got right!`
                        : `It's SBR Week ${currentRound}, Place your predictions in, for who you got winning this week!`
                    }
                </p>
