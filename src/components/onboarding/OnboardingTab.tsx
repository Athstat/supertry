...
export default function OnboardingTab({ tab, className }: Props) {
  ...
  return (
    <div className={twMerge('w-full items-center flex flex-col gap-6 justify-center', className)}>
      <img src={imageUrl} className="rounded-2xl w-[90%] sm:w-[80%] md:w-[70%]" />

      <div className="flex flex-col gap-2 w-full items-center justify-center text-center">
        <h2 className="text-3xl font-extrabold text-slate-900 dark:text-slate-900">{title}</h2>
