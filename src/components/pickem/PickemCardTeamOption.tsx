    ...
    return (
        ...
        >
            ...
            <div className={twMerge(
                ...
                !isHomeTeam && "justify-end items-center"
            )}>
                ...
                <div className={twMerge(
                    "text-[8px] text-center text-wrap font-medium w-fit text-slate-700 dark:text-slate-200 flex flex-row items-center gap-1",
                )} >
