        ...
        {hasPassword && (
          <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-row items-center justify-end">
              <p onClick={handleForgotPassword} className="text-primary-500 underline font-medium">
                Forgot Password?
              </p>
            </div>
          </div>
          ...
          {needsPasswordReset && email && (
            ...
            >
              <WarningCard className="py-2 gap-2">
                ...
                <p className="text-sm">
                  For security reasons, a password reset link has been sent to your email,{' '}
                  <strong> {email}</strong>. Please reset your password then login.
                </p>
              </WarningCard>
            </motion.div>
          )}
