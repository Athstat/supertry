...
export default function AppleOAuthBox() {
            ...
            <AppleSignin
                ...
                render={(renderProps: any) => (
                    <PrimaryButton
                        ...
                        className="w-full bg-white dark:bg-gray-900 text-gray-900 dark:text-white flex items-center justify-center space-x-2 px-4 py-3 rounded-xl hover:shadow-lg hover:bg-gray-50 dark:hover:bg-slate-800 font-medium border border-gray-300 dark:border-gray-800 transition-all duration-200"
                    >
