...
export function LeagueInsights() {
  return (
    <div className="bg-white dark:bg-dark-850 rounded-xl shadow-sm dark:shadow-dark-sm mt-6 border border-gray-200 dark:border-dark-600">
      ...
      <div className="p-4 space-y-4">
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-600 dark:text-gray-400">Highest Score (GW12)</div>
        ...
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-600 dark:text-gray-400">Most Selected Player</div>
