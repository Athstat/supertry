...
function EditTeamButton({team} : EditButtonProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center fixed mb-20 h-12 bottom-0 left-0" >
      <button onClick={handleClick} className="flex font-medium h-full rounded-xl text-white flex-row items-center w-[90%] gap-2 bg-blue-700 hover:bg-blue-800 justify-center animate-glow" >
        Edit Team
      </button>
    </div>
  )
