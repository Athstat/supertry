...
export function LeagueHeader({ leagueInfo, onOpenSettings }: LeagueHeaderProps) {
  return (
    <div className="bg-gradient-to-r from-primary-600 to-primary-500 text-white">
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">{leagueInfo.name}</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white/10 rounded-lg p-4">
            ...
            <div className="text-xl font-bold">{leagueInfo.currentGameweek}/{leagueInfo.totalGameweeks}</div>
          </div>
          <div className="bg-white/10 rounded-lg p-4">
