...
/** Renders a fantasy league group overview */
export function FantasyLeagueOverviewCard({ leagueGroup, custom = 0, onClick, className }: Props) {
    ...
    return (
        <motion.div
            ...
            className={twMerge(
                "bg-white dark:bg-gray-800/60 border border-slate-300 dark:border-slate-700 rounded-2xl p-4 shadow-md hover:shadow-lg cursor-pointer transition-all duration-200 space-y-2",
                className
            )}
            whileHover={{
                scale: 1.02,
        ...
        >
            ...
            {leagueGroup.description && (
                <p className="text-xs italic text-wrap text-gray-600 dark:text-gray-300 truncate">
                    {leagueGroup.description}
                </p>
            )}
