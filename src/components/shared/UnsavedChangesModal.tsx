...
export default function UnsavedChangesWarningModal({ message, title }: Props) {
    return (
        <DialogModal
            open={true}
            hideCloseButton
        ...
        >
            ...
            <div className="flex flex-col items-center justify-end gap-2" >
                <TranslucentButton className="text-slate-800 border-slate-300" >Cancle</TranslucentButton>
                <PrimaryButton destroy  className="" >Discard</PrimaryButton>
            </div>
