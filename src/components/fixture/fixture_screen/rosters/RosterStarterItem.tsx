    ...
    return (
        ...
        >
            {item && <div className={twMerge(
                ...
                <div className="max-w-16 drop-shadow-lg shadow-black bg-green-800 dark:bg-green-600 max-h-16 min-w-16 min-h-16 flex flex-col items-center rounded-full overflow-hidden border-2 border-green-200/40 dark:border-green-500/20 " >
                    <TeamJersey
                        teamId={item.team_id}
