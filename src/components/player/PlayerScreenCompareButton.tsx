    ...
    return (
        <div>
            ...
            <button
                onClick={onClick}
                className={twMerge(
                    "flex text-xs md:text-sm lg:text-base items-center dark:text-white text-slate-700 gap-2 px-4 py-2 bg-gray-100 dark:bg-dark-800/40 hover:bg-gray-200 dark:hover:bg-dark-800 rounded-lg font-medium",
