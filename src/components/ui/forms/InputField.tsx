        ...
        <div className={twMerge(className)} >
            ...
            <div className="relative">
                <input
                    ...
                    required={required}
                    className={twMerge(
                        "w-full h-[50px] px-6 bg-[#F0F3F7] dark:bg-dark-800/40 border border-[#475569] dark:border-slate-600 rounded-[30px] focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent dark:text-gray-100  placeholder:text-[#63686E] text-[12px]",
                        icon && "pr-12",
