...
export default function RoundedCard({children, className, onClick} : Props) {
    ...
    return (
        ...
        <div
            onClick={handleClick}
            className={twMerge(
                " dark:text-white dark:hover:text-slate-50  dark:hover:bg-slate-800/50 border-[1px] dark:border border-slate-300 dark:border-slate-800 rounded-2xl transition-all",
