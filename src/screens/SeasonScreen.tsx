...
export default function SeasonScreen() {
  ...
  const { data: season, isLoading } = useSWR(fetchKey, () =>
  ...
  const atoms = [seasonAtom, seasonTeamsAtoms, seasonFixtutesAtoms, seasonAthletesAtoms];
...
function SeasonScreenContent() {
  ...
  return (
    ...
    >
      <SeasonScreenTeamList teams={teams} />

      {/* <SeasonScreenAthleteList 
                athletes={athletes}
            /> */}

      <SeasonScreenFixturesList fixtures={fixtures} />
    </TopicPageView>
  );
}
