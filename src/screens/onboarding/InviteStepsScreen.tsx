    ...
    return (
        <PageView className='dark:bg-black w-full h-[100vh] overflow-y-auto p-4 gap-4 flex flex-col items-center ' >
            ...
            <div className='flex flex-col items-center gap-4 justify-center' >
                ...
                <SecondaryText className='text-center w-4/5 lg:w-[1/2] text-slate-700' >Congrats! You have been invited by <strong>{userName}</strong> to join <strong>{leagueName}</strong></SecondaryText>
            </div>
            ...
            <div className='flex flex-col gap-6 w-full p-4' >
                ...
                <div className='flex flex-col w-full gap-4' >
                    <p>Create an account or sign in into the app in order to setup your profile</p>
                </div>
            </div>
            ...
            <div className='flex flex-col gap-6 w-full p-4' >
                ...
                <div className='flex flex-col w-full gap-4' >
                    <p>Navigate to Leagues Screen and click on 'Join by code' and paste in the league join code <strong>{(joinCode ?? '').toUpperCase()}</strong></p>
                </div>
            </div>
